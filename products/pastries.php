...
<head>
	<meta charset="UTF-8" />
	<title>Born 2 Bread | The Pastries</title>
				...
				<li>
					<div>
					  <div>
						...
						<a href="#"><img src="../images/1.1.jpg" alt="Image" /></a>
					</div>
			  </li>
				<li>
					<div>
						<div>
						  <h2><a href="#">FOGLIATELL LG</a></h2>
                          <p>PRODUCT NO: 886</p>
                          <p>&nbsp; </p>
                          <p>&nbsp;</p>
                      <a href="#" class="view">Order</a> </div>
						<a href="#"><img src="../images/2.2.jpg" alt="Image" /></a>
					</div>
				</li>
				<li>
					<div>
